...
switch flag,
  ...
  %%%%%%%%%%%%%%%%%%
  case 0,
    [sys,x0,str,ts,simStateCompliance]=mdlInitializeSizes(hini);
  ...
  %%%%%%%%%%
  case 2,
    sys=mdlUpdate(t,x,u, R, hmax, A, hini);

  %%%%%%%%%%%
  % Outputs %
  %%%%%%%%%%%
  case 3,
    sys=mdlOutputs(t,x,u, R, hmax, A, hini);
...
%=============================================================================
%
function [sys,x0,str,ts,simStateCompliance]=mdlInitializeSizes(hini)
...
%=============================================================================
%
function sys=mdlUpdate(t,x,u, R, hmax, A, hini)
